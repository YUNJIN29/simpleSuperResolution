...
class TrainOptions:
    ...
    def _setParameters(self):
        ...
        self.parser.add_argument('--data-prefix', default='', help="数据集中目标的文件名前缀")
        self.parser.add_argument('--data-subfix', default='', help="数据集中目标的文件名后缀")
        self.parser.add_argument('--train-prefix', default='', help="训练集中训练目标的文件名前缀")
